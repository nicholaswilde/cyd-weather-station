...
- [ ] Task: Write tests for geolocation response parsing in `test_weather_client`
- [ ] Task: Create `fetchIpLocation` method inside `WeatherClient`
- [ ] Task: Implement HTTP JSON parser for `ip-api.com` structure
