...
- [ ] Task: Add sensor reading and filtering logic
    ...
    - [ ] Integrate backlight manager into [main.cpp](file:///home/nicholas/git/nicholaswilde/cyd-weather-station/src/main.cpp) setup and loop (sampling every 1 second)
