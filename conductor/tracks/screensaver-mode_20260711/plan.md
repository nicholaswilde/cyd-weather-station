...
- [ ] Task: Create `ScreenSaverManager` or add touch timestamp monitoring in `main.cpp`
- [ ] Task: Implement soft-dimming and soft-brightening functions in `BacklightManager`
