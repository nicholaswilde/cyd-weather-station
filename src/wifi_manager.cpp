...
#elif defined(ILI9341_2_DRIVER) || defined(ILI9341_DRIVER) || defined(ST7789_DRIVER)
...
void WifiManager::handleRoot() {
    ...
    html += "<label for='tz'>Timezone</label>";
    html += "<select id='tz' name='tz'></select>";
